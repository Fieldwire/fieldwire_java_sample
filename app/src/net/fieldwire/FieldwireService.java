...
public interface FieldwireService {
    ...
    SheetUpload createSheetUpload(@Header("Authorization") String authorization, @Header("Content-type") String contentType, @Path("projectId") UUID projectId, @Body Map<String, Object> sheetUpload);
    ...
    AWSPostToken getAWSPostToken(@Header("Authorization") String authorization, @Header("Content-type") String contentType);
}
